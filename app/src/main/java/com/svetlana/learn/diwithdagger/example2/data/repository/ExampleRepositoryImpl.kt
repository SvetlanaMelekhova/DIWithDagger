...
import com.svetlana.learn.diwithdagger.example2.di.FakeQualifier
import com.svetlana.learn.diwithdagger.example2.di.RemoteQualifier
import com.svetlana.learn.diwithdagger.example2.domain.ExampleRepository
import javax.inject.Inject

class ExampleRepositoryImpl @Inject constructor(
    private val localDataSource: ExampleLocalDataSource,
    @FakeQualifier private val remoteDataSource: ExampleRemoteDataSource,
